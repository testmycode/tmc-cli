...
public class Osa5bTest {
    ...
    public void testi() {
        ...
        for (int i = 0; i < syotteet.length; i++) {
            tarkasta(syotteet[i], "Parittomia");
        }
    }
    ...
    private static int otaLukuLopusta(String inputStr) {
        ...
        assertTrue("Tulostuksessa on oltava rivi muotoa \"Parittomia: 3\"", matcher.find());
    ...
    private String rivi(String out, String mj) {
        ...
        fail("Ohjelmasi pitäisi tulostaa parittomien lukujen lukumäärä"
                + "tulostamalla rivi muotoa \"Parittomia: 3\"\n");
        return "";    
    }
}
