...
public class Osa3Test {
    ...
    private static int otaLukuLopusta(String inputStr) {
        ...
        assertTrue("Tulostuksessa on oltava rivi muotoa \"Lukuja: 3\"", matcher.find());
    ...
    private String rivi(String out, String mj) {
        ...
        fail("Ohjelmasi pitäisi tulostaa lukujen lukumäärä tulostamalla rivi muotoa \"Lukuja: 3\"\n");
        return "";    
    }
}
