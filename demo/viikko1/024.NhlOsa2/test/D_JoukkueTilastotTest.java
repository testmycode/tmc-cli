...
@Points("24")
public class D_JoukkueTilastotTest {
    ...
    public void testi() {
        ...
        String viesti =  "komennoilla \""+input+"\" pitäisi tulostaa Anaheimin tilastot pisteiden mukaan järjestettynä";
        
        assertCalled(0, "sortByPoints", viesti+ " muistathan järjestää pelaajat ensin!");
